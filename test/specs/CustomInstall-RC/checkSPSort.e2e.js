...
describe('NOVA-2990 Scenario #47: Shared Packages/Teams - Sort functionality', () => {
    ...
    it('Sort functionality should work well - By Product type', async () => {
        ...
        // Get first package name
        let package_type = await customInstallPage.elmGetPckType("pe1nO")
        ...
        // Get actual package name
        let actualPackage_type = await customInstallPage.elmGetPckType("pe1nO")
    ...
    it('Sort functionality should work well - By Last Saved', async () => {
        ...
        let package_lastSaved = await customInstallPage.elmGetPckLastSaved("pe1nO")
        ...
        let actualPackage_lastSaved = await customInstallPage.elmGetPckLastSaved("pe1nO")
    ...
    it('Sort functionality should work well - By Products', async () => {
        ...
        let package_products = await customInstallPage.elmGetPckProducts("3Fbwr")
        ...
        let actualPackage_products = await customInstallPage.elmGetPckProducts("3Fbwr")
