...
describe('NOVA-2945 Scenario #43: Shared Packages/Teams - Basic elements', () => {
    it('Shared Packages - User should be able to validate basic elements', async () => {
        ...
        await expect(customInstallPage.elmTeamDropdown()).toBeExisting()
        console.log("Team dropdown exists");
        ...
        await expect(customInstallPage.elmIconImg(5)).toBeExisting()
        ...
        console.log("The ond of the script: User should be able to see basic element")
    });
});