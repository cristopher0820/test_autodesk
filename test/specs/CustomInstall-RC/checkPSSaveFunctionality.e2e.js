...
describe('NOVA-2946 Scenario #44: Shared Packages/Teams - New package - Save functionality', () => {
    it('Shared Packages - User should be able to save the deployment file', async () => {
        ...
        console.log("The ond of the script: User should be able to save the deployment file in Team Library")
    });
});