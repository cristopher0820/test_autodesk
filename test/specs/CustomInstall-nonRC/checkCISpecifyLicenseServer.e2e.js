...
describe('NOVA-2902 Scenario #41: Custom install Page - Specify license server', () => {
    it('Specify license server options and fields should display well', async () => {
        ...
        await customInstallPage.clickLicenseTypeItem("Redundant license server")
        ...
        await customInstallPage.clicklicenseServerModelSel()
        await customInstallPage.clickLicenseTypeItem("Distributed License Server")
        ...
        await customInstallPage.clicklicenseServerModelSel()
        await customInstallPage.clickLicenseTypeItem("Single license server")
